...
const proxyRoutes = ['/auth', '/users', '/orders', '/assign', '/reports', '/health', '/picker-admin', '/packer-admin', '/picker', '/packer', '/outbound', '/archive', '/sales', '/marketing', '/stock', '/products', '/warehouses', '/incidents', '/branding']

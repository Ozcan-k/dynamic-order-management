...
const proxyRoutes = ['/auth', '/users', '/orders', '/assign', '/reports', '/health', '/picker-admin', '/packer-admin', '/picker', '/packer', '/outbound', '/dispatch', '/archive', '/sales', '/marketing', '/stock', '/products', '/warehouses', '/incidents', '/returns', '/branding', '/accounting', '/employee-schedule']

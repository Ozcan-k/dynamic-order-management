...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    roles: [UserRole.ADMIN, UserRole.WAREHOUSE_ADMIN],
    children: [
      { path: '/inventory/products', label: 'Product', icon: <StockIcon />, roles: [UserRole.ADMIN, UserRole.WAREHOUSE_ADMIN] },
      { path: '/inventory/items', label: 'Inventory', icon: <StockIcon />, roles: [UserRole.ADMIN, UserRole.WAREHOUSE_ADMIN] },
      { path: '/inventory/warehouses', label: 'Warehouse', icon: <StockIcon />, roles: [UserRole.ADMIN, UserRole.WAREHOUSE_ADMIN] },
      { path: '/inventory/stock', label: 'Stock', icon: <StockIcon />, roles: [UserRole.ADMIN, UserRole.WAREHOUSE_ADMIN] },
      { path: '/inventory/stock-out', label: 'Stock Out', icon: <StockIcon />, roles: [UserRole.ADMIN, UserRole.WAREHOUSE_ADMIN] },
    ],
  },
  {
    path: '/sales',

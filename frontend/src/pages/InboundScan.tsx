          ...
          <div style={{ position: 'fixed', inset: 0, background: '#000', zIndex: 100, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ position: 'relative', width: '100%', maxWidth: '500px' }}>
              ...
              <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: '72%', height: '130px', pointerEvents: 'none' }}>
                <div style={{ position: 'absolute', top: 0, left: 0, width: 28, height: 28, borderTop: '3px solid #22c55e', borderLeft: '3px solid #22c55e', borderRadius: '3px 0 0 0' }} />
                <div style={{ position: 'absolute', top: 0, right: 0, width: 28, height: 28, borderTop: '3px solid #22c55e', borderRight: '3px solid #22c55e', borderRadius: '0 3px 0 0' }} />
                <div style={{ position: 'absolute', bottom: 0, left: 0, width: 28, height: 28, borderBottom: '3px solid #22c55e', borderLeft: '3px solid #22c55e', borderRadius: '0 0 0 3px' }} />
                <div style={{ position: 'absolute', bottom: 0, right: 0, width: 28, height: 28, borderBottom: '3px solid #22c55e', borderRight: '3px solid #22c55e', borderRadius: '0 0 3px 0' }} />
                <div style={{ position: 'absolute', top: '50%', left: '5%', right: '5%', height: '2px', background: 'linear-gradient(90deg, transparent, #22c55e, transparent)', animation: 'scanline 1.5s ease-in-out infinite' }} />
                <div style={{ position: 'absolute', inset: 0, boxShadow: '0 0 0 9999px rgba(0,0,0,0.65)' }} />
              </div>
            </div>
            <p style={{ color: '#cbd5e1', fontSize: '16px', marginTop: '28px', fontWeight: 600, letterSpacing: '0.01em' }}>Align barcode within the frame</p>

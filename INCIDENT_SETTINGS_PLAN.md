...
> **Status:** 🚧 IN PROGRESS — **v2.91.0 (Incident) ✅ tamam** — I1 + I2 + I3 lokal test edildi, `v2.91.0-test` olarak test'e push; main kullanıcı onayı bekliyor. Sıradaki: v2.92.0 (S1).
